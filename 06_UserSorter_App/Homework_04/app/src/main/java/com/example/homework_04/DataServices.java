...
public class DataServices {
    ...
    public static ArrayList<DataServices.User> getAllStateNames(){
        ArrayList<DataServices.User > state= new ArrayList<>();
        for (User user:users) {
            state.add(new User(user.state));
        }
        return state;
    }

    //method to get unique state list
    public static ArrayList<DataServices.User> methodToGetUniqueUserListArray() {
        ArrayList<DataServices.User> uniqueList= new ArrayList<>();
        ArrayList<String> stateList = new ArrayList<>();
        for (DataServices.User user :getAllStateNames()) {
            stateList.add(user.getState());
        }
        Set<String> uniqueSet = new HashSet<>(stateList);
        stateList.clear();
        stateList.addAll(uniqueSet);
        for (String state: stateList) {
            uniqueList.add(new DataServices.User(state));
        }
        Collections.sort(uniqueList,new StateAscendingSort());
        return uniqueList;
    }
